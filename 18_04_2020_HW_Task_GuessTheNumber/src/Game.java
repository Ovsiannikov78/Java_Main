...
public class Game {
    ...
    public static void main(String[] args) {
        //guessTheNumberWithForLoop();
        guessTheNumberWithWhile();
    }

    /* The user must guess the number in the range from 0 to 10.
       User has 3 attempts*/

   /* public static void guessTheNumberWithForLoop() {
    ...
    public static void guessTheNumberWithWhile() {
        System.out.println("Let's start our game. You have 3 attempts.");
        System.out.println("You can enter numbers from 0 to 10.");
        int number = (int) (Math.random() * 10);
        int attempt = 3;
        while (attempt >= 1) {
            ...
            if (inputNumber < 0 || inputNumber > 10) {
                ...
                attempt--;
                System.out.println("You didn't guess. You have left " + (attempt) + " attempt.");
            } else {
                System.out.println("Game over :-( You can try again.");
                break;
            }
